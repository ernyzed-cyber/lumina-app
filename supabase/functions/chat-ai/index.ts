...
// вызывает OpenRouter, возвращает ответ. Асинхронно сохраняет новое воспоминание.
//
...
// Бесплатная мощная модель на OpenRouter без TPM лимитов
    ...
    const summaryPrompt: ChatMessage[] = [
      {
        role: 'system',
        content:
          'You read a chat transcript and write a brief diary entry summary in Russian (2-3 sentences, first person "мы говорили о..."). Only capture important facts about the interlocutor and emotional tone. No fluff. No emoji.',
      },
